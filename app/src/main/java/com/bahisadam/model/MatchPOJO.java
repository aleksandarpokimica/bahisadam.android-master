...
import com.bahisadam.model.teamInfo.GoalTimeStatistics;
...
public class MatchPOJO {
    ...
    public class Match {
        ...
        @JsonProperty("link")
        private String link;
        @JsonProperty("other_match_id")
        private String otherMatchId;
        @JsonProperty("other_match")
        ...
        @JsonProperty("other_match_id")
        public String getOtherMatchId() { return this.otherMatchId = otherMatchId; }

        public void setOtherMatchId() { this.otherMatchId = otherMatchId; }
        ...
        @JsonProperty("other_match")
        public void setOtherMatch(Match match) {
    ...
    public class LeagueId {
        ...
        public void setCoverage(String cov) { coverage = cov; }
    ...
    public class MatchDetailed {
        ...
        private MatchPOJO.Match other_match;
...
*/
        ...
        public MatchPOJO.Match getOtherMatch(){
            return other_match;
        }

        public void setOther(MatchPOJO.Match value) {
            other_match = value;
        }
    }
    @Generated("org.jsonschema2pojo")
  ...
  //          "team_logos",
    ...
    public class TeamStats {
        @SerializedName("data")
        @Expose
        private TeamStatsObj stats = null;

        public TeamStatsObj getStats() {
            return stats;
        }

        public void setStats(TeamStatsObj stats) {
            this.stats = stats;
        }
    }
    ...
    public class TeamStatsObj {
        ...
        @Expose
        private List<PlayerStat> goals = null;

        @SerializedName("assist_leaders")
        @Expose
        private List<PlayerStat> asists = null;

        @SerializedName("card_leaders")
        @Expose
        private List<PlayerStat> cardsList = null;

        @SerializedName("goaltime_statistics")
        @Expose
        private GoalTimeStatObj goaltime_statistics_obj = null;

        @SerializedName("goals_scored")
        @Expose
        private float goals_scored = 0f;

        @SerializedName("goals_conceded")
        @Expose
        private float goals_conceded = 0f;

        @SerializedName("goals_by_foot")
        @Expose
        private float goals_by_foot = 0f;

        @SerializedName("goals_by_head")
        @Expose
        private float goals_by_head = 0f;
        ...
        @SerializedName("sot")
        @Expose
        private float sot = 0f;

        @SerializedName("son")
        @Expose
        private float son = 0f;

        @SerializedName("soff")
        @Expose
        private float soff = 0f;

        @SerializedName("blk")
        @Expose
        private float blk = 0f;

        @SerializedName("frk")
        @Expose
        private float frk = 0f;
        ...
        public List<PlayerStat> getAsists() {
            return asists;
        }

        public void setAsists(List<PlayerStat> asists) {
            this.asists = asists;
        }
        ...
        public List<PlayerStat> getCardsList() {
            return cardsList;
        }

        public GoalTimeStatObj getGoaltime_statistics_obj() {
            return goaltime_statistics_obj;
        }

        public void setGoaltime_statistics_obj(GoalTimeStatObj goaltime_statistics_obj) {
            this.goaltime_statistics_obj = goaltime_statistics_obj;
        }

        public void setCardsList(List<PlayerStat> cardsList) {
        ...
        public float getGoals_by_foot() {
            return goals_by_foot;
        }

        public void setGoals_by_foot(float goals_by_foot) {
            this.goals_by_foot = goals_by_foot;
        }

        public float getGoals_by_head() {
            return goals_by_head;
        }

        public void setGoals_by_head(float goals_by_head) {
        ...
        public void setCards(float cards) {
            this.cards = cards;
        }
    ...
    public class GoalTimeStatObj {

        @SerializedName("scored")
        @Expose
        private GoalTimeStat scored = null;

        @SerializedName("conceded")
        @Expose
        private GoalTimeStat received = null;

        public GoalTimeStat getScored() {
            return scored;
        }

        public void setScored(GoalTimeStat scored) {
            this.scored = scored;
        }

        public GoalTimeStat getReceived() {
            return received;
        }

        public void setReceived(GoalTimeStat conceded) {
            this.received = conceded;
        }
    }

    public class GoalTimeStat {
    ...
    public class PlayerStat {
        ...
        public String getSr_id_squad() {
            return sr_id_squad;
        }

        public void setSr_id_squad(String sr_id_squad) {
            this.sr_id_squad = sr_id_squad;
        }
