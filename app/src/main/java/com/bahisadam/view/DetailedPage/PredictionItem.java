...
import com.bahisadam.holder.PredictionHolder;
...
public class PredictionItem  implements Item, View.OnClickListener {
    ...
    public void bindViewHolder(RecyclerView.ViewHolder cardHolder) {
        try {
            holder = (PredictionHolder) cardHolder;
            ...
            ((View) holder.iyalt15.getParent().getParent()).setOnClickListener(this);
            ((View) holder.iyust15.getParent().getParent()).setOnClickListener(this);
    ...
    private void setupRates(MatchPOJO.Iddaa odds) {
        if(odds!=null){
            ...
            loadToView(holder.iyalt15,odds.getiY15Alt());
            loadToView(holder.iyust15,odds.getiY15St());
            loadToView(holder.alt15,odds.get_15Alt());
            loadToView(holder.ust15,odds.get_15St());
    ...
    private void click(int id){
        ...
        switch (id){
            ...
            case R.id.alt15: setForecast("15Alt"); break;
            case R.id.ust15: setForecast("15Üst"); break;
            case R.id.iyalt15: setForecast("IY15Alt"); break;
            case R.id.iyust15: setForecast("IY15Üst"); break;
