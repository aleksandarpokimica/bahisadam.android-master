package com.bahisadam.utility.slider.animations.indicators;
...
public class PagerIndicator extends LinearLayout implements ViewPagerEx.OnPageChangeListener{
    ...
    public PagerIndicator(Context context, AttributeSet attrs) {
        ...
        mDefaultSelectedColor = attributes.getColor(R.styleable.PagerIndicator_selected_color, Color.rgb(0, 255, 0));
