...
public class LineupsAdapter extends SectionedRecyclerViewAdapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder itemHolder, int section, int relativePosition, int absolutePosition) {
        ...
        fillViews(holder.homePlayer,holder.homePlayerNumber, holder.homePlayerPos, player);
        player = null;
        ...
        fillViews(holder.awayPlayer,holder.awayPlayerNumber, holder.awayPlayerPos, player);

    }
    public void fillViews(TextView playerTv, TextView numberTv, TextView playerPos, MatchPOJO.Player player) {
        if(player != null){
            ...
            if(player.type != null) {
                switch (player.type) {
                    ...
                    case "forward" :
                        playerPos.setText("F");
                        break;
                    default: playerPos.setText(player.type); break;
                }
            }
    ...
    public class ItemHolder extends RecyclerView.ViewHolder {
        ...
        @BindView(R.id.homePlayerPos) TextView homePlayerPos;
        @BindView(R.id.awayPlayerPos) TextView awayPlayerPos;
